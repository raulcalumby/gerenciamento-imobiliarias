		        ...
		        if (status == 'Valid') {
					...
					$.ajax({
							...
							success:function(response) {
								...
								{
									setCookie('account_id', response['account_id'], 30);
			...
			form,
			{
				fields: {
					fullname: {
						validators: {
							notEmpty: {
								message: 'Preencha com seu email'
							}
						}
					},
					email: {
...
const inputEle = document.getElementById('pass_input');
...
const inputEle2 = document.getElementById('pass_input');
